...
class Rule extends \M2E\Otto\Model\ActiveRecord\AbstractModel
{
    ...
    /** @var \M2E\Otto\Model\Magento\Product\Rule\Condition\CombineFactory */
    private Rule\Condition\CombineFactory $ruleConditionCombineFactory;
     ...
     * @return \M2E\Otto\Model\Magento\Product\Rule\Condition\Combine
     * @throws \M2E\Otto\Model\Exception
     */
    ...
    public function isEmpty()
    {
        ...
        foreach ($this->_conditions->getConditionModels() as $model) {
            if ($model instanceof \M2E\Otto\Model\Magento\Product\Rule\Condition\Product) {
     ...
     *                        ->createBlock('Otto/adminhtml_magento_product_rule')
